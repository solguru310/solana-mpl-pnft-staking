...
import idl from '../target/idl/mpl_pnft_staking.json';
import { MplPnftStaking } from '../target/types/mpl_pnft_staking';

const IDL: MplPnftStaking = idl as MplPnftStaking;
